...
def gamma_kernel(image, maskSize=16, d=2, k=np.array([5, 10, 5, 20, 5, 30], dtype=float),mu = np.array([4, 4, 4, 4, 4, 4], dtype=float) ):
    #k=np.array([1, 10, 1, 15, 1, 35], dtype=float),mu = np.array([4, 4, 4, 4, 4, 4], dtype=float)k = [1, 10, 1, 15, 1, 20]
    #[5, 30, 5, 40, 5, 50]
